...
public class SpriteMove : MonoBehaviour
{
    ...
    public List<SpriteMoveData> defaultAnimations;  // SOのリスト

    [Header("スキル用アニメーション（未使用）")]
    public List<SpriteMoveData> skillAnimations;    // 今後使用予定
    ...
    void Update()
    {
        ...
        if (actionController.ThisAction != prevAction)
        {
            ...
            SpriteMoveData data = defaultAnimations[currentAnimIndex];
